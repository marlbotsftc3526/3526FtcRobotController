...
@Autonomous(name = "Auto15Blue", group = "AutoTemplates")
public class Auto15Blue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(new Pose(31.868, 132.7541, Math.toRadians(270)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            intakeballs1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(45.104, 97.352),
                                    new Pose(59.115, 55.915),
                                    new Pose(9.988, 58.493)
                            )
            ...
            launchzone2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(9.988, 58.493),
                                    new Pose(51.892, 65.000),
                                    new Pose(44.697, 97.535)
                            )
            ...
            opengate = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(44.697, 97.535),
                                    new Pose(48.185, 63.955),
                                    new Pose(10.251, 61.966)
                            )
            ...
            launchzone3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(10.251, 61.966),
                                    new Pose(60.612, 76.339),
                                    new Pose(45.104, 97.028)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(315))
            ...
            intakeballs2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(45.104, 97.028),
                                    new Pose(74.159, 83.328),
                                    new Pose(13.834, 83.529)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(180))
            ...
            intakeballs3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(45.135, 97.289),
                                    new Pose(72.880, 27.375),
                                    new Pose(11.690, 35.268)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(180))
            ...
            launchzone5 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(11.690, 35.268),
                                    new Pose(33.980, 59.090),
                                    new Pose(45.064, 97.638)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(315))
