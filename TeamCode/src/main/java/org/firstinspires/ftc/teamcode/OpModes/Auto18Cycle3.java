    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            intakeballs1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(99.091, 97.352),
                                    new Pose(81.541, 62.183),
                                    new Pose(133.569, 55.920)
                            )
