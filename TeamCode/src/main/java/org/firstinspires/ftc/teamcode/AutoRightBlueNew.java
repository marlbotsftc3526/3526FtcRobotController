...
@Config
@Autonomous(name = "AutoRightBlueNew", group = "Linear Opmode")
public class AutoRightBlueNew extends LinearOpMode {
    ...
    public static double initx = -34, inity = 65, initheading = 3*Math.PI/2;
