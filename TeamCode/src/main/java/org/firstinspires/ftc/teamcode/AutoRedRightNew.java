...
@Config
@Autonomous(name = "AutoRightRedNew", group = "Linear Opmode")
public class AutoRedRightNew extends LinearOpMode {
    ...
    public static double initx = 10, inity = -65, initheading = Math.PI/2;
