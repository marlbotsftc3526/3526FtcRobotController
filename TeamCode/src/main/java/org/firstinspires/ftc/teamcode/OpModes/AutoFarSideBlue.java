...
@Disabled
@Autonomous(name = "AutoFarSideBlue", group = "AutoTemplates")
public class AutoFarSideBlue extends LinearOpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Shoot1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(56.000, 8.000), new Pose(56.499, 20.282))
                    )
            ...
            Side = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(56.499, 20.282), new Pose(34.189, 13.907))
                    )
