...
public class MotionProfile {
    ...
    public static double motionProfile(double max_acceleration, double max_velocity, double distance, double current_dt) {
    ...
    public static double motionProfileTime(double max_acceleration, double max_velocity, double distance, double current_dt) {
